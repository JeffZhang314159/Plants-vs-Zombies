	...
	void move() {
		...
		if (frozen == true) {
			...
			if (frozenTimer == frozenThaw) {
				...
				frozen = false;
				moveTimer = 0; // Resets moveTimer to 0 because while frozen, moveTimer could go up to 2, and then ++ would never
							   // == moveTrigger, and the zombie would never move
				frozenTimer = 0;
